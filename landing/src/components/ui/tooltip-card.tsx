      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            ...
            className="pointer-events-none absolute z-50 min-w-[15rem] overflow-hidden rounded-md border border-neutral-700 bg-neutral-900 shadow-sm ring-1 shadow-black/40 ring-white/10"
            style={{
              top: position.y,
              left: position.x,
            }}
          >
            <div
              ref={contentRef}
              className="p-2 text-sm text-neutral-300 md:p-4"
            >
              {content}
            </div>
          </motion.div>
